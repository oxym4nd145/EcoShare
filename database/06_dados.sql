...
-- ============================================
-- 7. INSERIR 25 TRANSAÇÕES (USANDO PROCEDURES)
-- ============================================

-- Doações (tipo 1) – sem preço, sem devolução
CALL criar_transacao(1, 2, 1, 1, NULL, NULL, '2024-01-15 10:30:00', '2024-01-16 14:00:00');
CALL criar_transacao(6, 3, 2, 1, NULL, NULL, '2024-02-10 09:15:00', '2024-02-11 11:00:00');
CALL criar_transacao(12, 8, 3, 1, NULL, NULL, '2024-03-05 16:20:00', '2024-03-06 10:30:00');
CALL criar_transacao(19, 12, 4, 1, NULL, NULL, '2024-04-12 14:45:00', '2024-04-13 15:15:00');
CALL criar_transacao(23, 18, 5, 1, NULL, NULL, '2024-05-20 11:10:00', '2024-05-21 09:45:00');

-- Aluguéis (tipo 2)
-- transação 6 (id será gerado automaticamente)
CALL criar_transacao(2, 4, 6, 2, 30.00, '2024-02-20', '2026-01-20 15:30:00', '2026-01-24 12:00:00');
CALL registrar_devolucao(LAST_INSERT_ID(), '2024-02-19');  -- já devolvido

CALL criar_transacao(4, 6, 7, 2, 50.00, '2024-03-15', '2024-02-15 13:20:00', '2024-02-16 14:30:00');
CALL registrar_devolucao(LAST_INSERT_ID(), '2024-03-12');

CALL criar_transacao(7, 9, 8, 2, 25.00, '2024-04-10', '2025-03-10 10:45:00', '2025-03-15 11:15:00');
CALL registrar_devolucao(LAST_INSERT_ID(), '2024-04-08');

CALL criar_transacao(10, 13, 9, 2, 40.00, '2024-05-05', '2024-04-05 16:10:00', '2024-04-06 10:45:00');
-- sem devolução, data_devolucao fica NULL

CALL criar_transacao(15, 17, 10, 2, 35.00, '2024-06-01', '2024-05-01 14:30:00', '2024-05-02 15:00:00');
CALL registrar_devolucao(LAST_INSERT_ID(), '2024-05-30');

CALL criar_transacao(18, 20, 11, 2, 20.00, '2024-06-25', '2024-05-25 09:15:00', '2024-05-26 14:20:00');
-- não devolvido

CALL criar_transacao(21, 22, 12, 2, 45.00, '2024-07-10', '2024-06-10 11:45:00', '2024-06-11 16:30:00');
-- não devolvido

-- Empréstimos (tipo 3)
CALL criar_transacao(3, 5, 13, 3, NULL, '2024-03-25', '2026-01-25 12:15:00', NULL);
CALL registrar_devolucao(LAST_INSERT_ID(), '2024-03-24');

CALL criar_transacao(8, 11, 14, 3, NULL, '2024-04-28', '2026-02-28 10:30:00', NULL);
CALL registrar_devolucao(LAST_INSERT_ID(), '2024-04-25');

CALL criar_transacao(11, 14, 1, 3, NULL, '2024-05-15', '2026-02-10 15:20:00', NULL);
-- não devolvido (update_date pode ser ajustado depois)

CALL criar_transacao(16, 19, 2, 3, NULL, '2024-06-10', '2024-04-10 14:10:00', NULL);
CALL registrar_devolucao(LAST_INSERT_ID(), '2024-06-08');

CALL criar_transacao(20, 23, 3, 3, NULL, '2024-07-05', '2024-05-05 16:45:00', NULL);
-- não devolvido

CALL criar_transacao(24, 26, 4, 3, NULL, '2024-08-01', '2024-06-01 09:30:00', NULL);
-- não devolvido

-- Vendas (tipo 4)
CALL criar_transacao(5, 7, 5, 4, 1200.00, NULL, '2024-02-01 15:45:00', '2024-02-02 11:30:00');
CALL criar_transacao(9, 10, 6, 4, 350.00, NULL, '2025-03-08 11:20:00', '2025-03-09 14:15:00');
CALL criar_transacao(13, 15, 7, 4, 180.00, NULL, '2024-04-18 13:45:00', '2024-04-19 10:30:00');
CALL criar_transacao(14, 16, 8, 4, 220.00, NULL, '2024-05-15 10:10:00', '2024-05-16 15:45:00');
CALL criar_transacao(17, 21, 9, 4, 480.00, NULL, '2025-06-05 16:20:00', '2025-06-06 12:00:00');
CALL criar_transacao(22, 24, 10, 4, 75.00, NULL, '2024-06-20 14:30:00', '2024-06-21 11:15:00');
CALL criar_transacao(25, 25, 11, 4, 150.00, NULL, '2024-07-01 10:45:00', '2024-07-02 14:00:00');
